...
public class ConsultarLibro extends javax.swing.JFrame {
    ...
    private void Tablajson() {
        DefaultTableModel t = new DefaultTableModel(new String[]{"Titulo", "Autor", "Genero", "Precio", "Stock"}, NuevoLibro.Librojson.size());
        jTable1.setModel(t);
        TableModel tabla = jTable1.getModel();
        for (int i = 0; i < NuevoLibro.Librojson.size(); i++) {
            Libro l = NuevoLibro.Librojson.get(i);
            tabla.setValueAt(l.getTitulo(), i, 0);
            tabla.setValueAt(l.getAutor(), i, 1);
            tabla.setValueAt(l.getGenero(), i, 2);
            tabla.setValueAt(l.getPrecio(), i, 3);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (borrar > -1) {
            if (JOptionPane.showConfirmDialog(this, "Estas seguro que quieres borrar el libro seleccionado") == 0) {
                ...
                NuevoLibro.Librojson.remove(borrar);
                ArchivoLibro.GuardarJson(NuevoLibro.Librojson);
